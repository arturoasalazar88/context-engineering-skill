...
| **Unverified Memory** | Storing guesses or assumptions | Verify before persisting |

---

## SESSION-LOG.md Maintenance

**Purpose:** Archive historical session summaries

**Max Size:** 200 lines (~3K tokens when loaded on demand)

**Pruning Strategy:**
- Keep last 6 months of sessions
- Archive older sessions to yearly files
- Review quarterly, remove redundant information
- Format: Most recent at top, chronological descending
