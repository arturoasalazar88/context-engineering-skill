---
description: Initialize a project with a complete context engineering structure for AI coding agents
---

# Context Engineering - Initialize Project

Initialize a project with a complete context engineering structure for AI coding agents.

## Instructions

When the user runs this workflow, follow these steps in order. This is an interactive wizard - ask questions one at a time and wait for answers.
...
Read templates from `templates/` directory and create files at the project root.
...
2. **.claude/rules/core-rules.md**
   - Template: `templates/core-rules.template.md`
...
3. **.claude/rules/context-enforcement.md**
   - Template: `templates/context-enforcement.template.md`
   - No replacements needed (already generic)

4. **.claude/rules/context-window-monitoring.md**
   - Template: `templates/context-window-monitoring.template.md`
   - No replacements needed (already generic)
...
6. **context/CONTEXT-SCHEMA.yaml**
   - Template: `templates/CONTEXT-SCHEMA.template.yaml`
   - Replace: `{{DATE}}`
   - Add project-specific per-task and on-demand file entries if relevant

7. **context/MEMORY-PROTOCOL.md**
   - Template: `templates/MEMORY-PROTOCOL.template.md`
   - Replace: `{{DATE}}`

8. **context/SYSTEM.md**
   - Template: `templates/SYSTEM.template.md`
...
1. Read `templates/story.template.md`
